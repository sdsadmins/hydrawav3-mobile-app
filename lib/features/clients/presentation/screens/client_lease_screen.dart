...
class ClientLeaseScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ClientLeaseScreen> createState() => _ClientLeaseScreenState();
}

class _ClientLeaseScreenState extends ConsumerState<ClientLeaseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.title ?? 'Device Lease'),
      ),
      body: _loading
