...
/// Paginated history of generated AI reports for a client (parity with the web
/// Client-Details table): each row summarizes discomfort areas + ROM with View +
/// Download. Rendered as a non-scrolling [Column] (pagination is button-driven)
/// so it can be embedded either as the body of the AI Reports screen or beneath
/// the lease card on the combined client detail screen.
